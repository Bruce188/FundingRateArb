...
#pragma warning restore CS0618
        ...
        DivergenceAlertConfirmationCycles = src.DivergenceAlertConfirmationCycles,
        RotationDivergenceHorizonHours = src.RotationDivergenceHorizonHours,
        PreferCloseOnDivergenceNarrowing = src.PreferCloseOnDivergenceNarrowing,
        UseRiskBasedDivergenceClose = src.UseRiskBasedDivergenceClose,
        MinEdgeMultiplier = src.MinEdgeMultiplier,
        UseBreakEvenSizeFilter = src.UseBreakEvenSizeFilter,
        ...
        StablecoinCriticalThresholdPct = src.StablecoinCriticalThresholdPct,
        DryRunEnabled = src.DryRunEnabled,
        ForceConcurrentExecution = src.ForceConcurrentExecution,
